...
# Create the clients for ECS, SSM, and Secrets Manager
...
# Define the mapping between the environment variables and the AWS SSM parameters
...
def _build_execution_cofig(env_name, extra_env_vars=None):
    # Get the parameters stored in AWS SSM
    config = {}
