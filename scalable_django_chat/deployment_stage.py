...
from .my_django_chat_app_stack import MyDjangoChatAppStack
from .static_files_stack import StaticFilesStack
from .external_secrets_stack import ExternalSecretsStack
from .dns_route_to_alb_stack import DnsRouteToAlbStack
from .message_broker_stack import MessageBrokerStack


class MyDjangoChatAppPipelineStage(Stage):
    ...
    def __init__(
        ...
        self.message_broker = MessageBrokerStack(
            self,
            "Broker",
            env=aws_env,  # AWS Account and Region
            vpc=self.network.vpc
        ...
        self.app_env_vars = {
            ...
            "REDIS_HOST": self.message_broker.endpoint_url,
            "REDIS_PORT": "6379"
        }
        ...
        self.django_app = MyDjangoChatAppStack(
            self,
            "AppService",
            env=aws_env,  # AWS Account and Region
            vpc=self.network.vpc,
